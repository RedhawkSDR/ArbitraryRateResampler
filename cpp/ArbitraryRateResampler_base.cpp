...
void ArbitraryRateResampler_base::construct()
{
...
*******************************************************************************************/
void ArbitraryRateResampler_base::initialize() throw (CF::LifeCycle::InitializeError, CORBA::SystemException)
{
}
...
void ArbitraryRateResampler_base::start() throw (CORBA::SystemException, CF::Resource::StartError)
{
    ...
    if (serviceThread == 0) {
        ...
        serviceThread = new ProcessThread<ArbitraryRateResampler_base>(this, 0.1);
        serviceThread->start();
    }
...
CORBA::Object_ptr ArbitraryRateResampler_base::getPort(const char* _id) throw (CORBA::SystemException, CF::PortSupplier::UnknownPort)
{
